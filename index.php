			...
			<div class="header-bot_inner_wthreeinfo_header_mid">
				...
				<div class="col-md-8 header">
					...
					<ul>
						...
						<!-- <li class="nav navbar-nav navbar-right"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span>Cart<span class="badge">0</span></a>
				...
				<li><div id="page-cart-icon" onclick="cart.toggle();">
                        ...
                        <div class="MultiCarousel-inner">
                            ...
                            <div class="item men-thumb-item">
                                <div class="pad15 ">
									...
									<input type="button" pid='$pro_id' style='float:center;width:144px;height:38px;' id='product' class='btn btn-danger btn-xs' value="AddToCart" onclick="cart.add(<?= $pr['slno'] ?>);"/>
							         <!-- [CART] -->
                                    ...
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="single.php?id=<?php echo $pr['slno']; ?>&catogory=<?php echo $pr['catogory'];?>" class="link-product-add-cart">Quick View</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
