...
<head>
	<title>Super express an Ecommerce website |</title>
	<!--/tags -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="Super express, Grocery Shoppy , super market website" />
	<script>
...
<body>
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="" method="POST">
											<fieldset>
												...
												<a href="cart.php?id=slno&action=add-to-cart" ><input type="button" class="button" value="Add to cart"></a>
								...
								<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
									<form  method="POST">
										<fieldset>
											...
											<input type="hidden" name="return" value=" " />
											<input type="hidden" name="cancel_return" value=" " />
											<input type="submit" name="submitCartItem" value="Add to cart" class="button" />
										</fieldset>
									</form>
								</div>
							</div>
	...
	<div class="copy-right">
		<div class="container">
			<p>© 2018 Super Express. All rights reserved | Design by
