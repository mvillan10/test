...
$sql = "SELECT * from products where catogory='$category' ORDER BY discountper desc LIMIT 10";
// echo $sql;
$view = $conn->query($sql);
							...
							<ul class="slides">
								<li data-thumb="uploads/<?php echo $product['12'] ?>" >
									<div class="thumb-image">
										<img src="uploads/<?php echo $product['12'] ?>" data-imagezoom="true" class="img-responsive" alt="">
									</div>
								</li>	
							</ul>
							<div class="clearfix"></div>
						...
						<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
							<form action="cart1.php" method="get">
							   ...
							   Stock:<?php echo $product['10']!=0? $product['10'] : 'not in stock' ?> 
								...
								<br>
								<?php echo $product['10']!=0? '<input type="submit" name="action" value="Add to Cart" class="button" />':'' ?>
								</fieldset>
							</form>
						</div>
