...
<head>
	<title>Super Express an Ecommerce website | ictcodes</title>
	<!--/tags -->
...
<body>
			...
			<div class="col-md-8 header">
				...
				<ul>
						...
						<li>
								...
								<span class="fa fa-unlock-alt" aria-hidden="true"></span><?php echo $_SESSION['id']? $_SESSION['username']: '<a href="#" data-toggle="modal" data-target="#myModal1">Sign In & Sign Up</a>' ?>  
						</li>
						<!-- <li>
			...
			<div class="agileits-navi_search">
				<form action="#" method="post">
					<select id="agileinfo-nav_search" name="agileinfo_search" required="">
						...
						<?php } ?>
						<!-- <option value="Kitchen">Food Products</option>
	...
	<footer>
		<div class="container">
			...
			<!-- <p class="footer-main">
				<span>"Super Express"</span> Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-5 address-right">
					...
					<div class="col-xs-6 footer-grids">
						...
						<ul>
							<li>
								<i class="fa fa-map-marker"></i> 123 Kerala, India.</li>
							<li>
							...
							<li>
								...
								<a href="mailto:example@mail.com"> mail@superexpress.com</a>
							</li>
						</ul>
					</div>
				</div>
	...
	<div class="copy-right">
		<div class="container">
			<p>© 2019 Super Express. All rights reserved | Design by
				<a href="https://ictcodes.net/"> ictcoeds.</a>
			</p>
		</div>
	</div>
	<!-- //copyright -->
...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/04-01-2018/grocery_shoppy-demo_Free/709526329/web/single2.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Feb 2019 08:10:40 GMT -->
</html>