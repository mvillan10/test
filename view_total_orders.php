				...
				<div class="modal-content">
					...
					<div class="modal-body modal-body-sub_agile">
						...
						<div class="modal_body_left modal_body_left1">
							...
							<p>
							HI,<?php echo $_SESSION['username']; ?> Confirm Your Delivered Address
							...
							<form action="order.php" method="post">
								...
								?>
								<div class="styled-input agile-styled-input-top">
									<input type="text" name="phone" value="<?php echo $row2['phone'];?>">
								</div>
								<div class="styled-input agile-styled-input-top">
									<input type="text"  name="add" value="<?php echo $row2['address']; ?>">
								</div>
  ...
  <div class="form-row">
    <div class="form-group col-md-2">
      <label for="inputEmail">Total Price</label>
            <?php 
            $totalPrice = mysqli_query($conn, "SELECT SUM(totalprice) AS total FROM orders where order_id = $order ");
            $sum = mysqli_fetch_array($totalPrice);
             ?>
             
        <input type="text" class="form-control" value="€ <?php echo $sum ['total']; ?>">
        </div>
        </div>
        </form>
        <a href="user_order.php"><button type="button" class="btn btn-warning" style="margin-top:29px;">BACK</button></a>
            <table class="table" >
                        <thead>
                            <tr>
                                <th>Product</th>
                        ...
                        <tbody>
                            ...
                            <tr class="gradeX">
                                ...
                                <!--<td><a href="view_total_orders.php?$order_no=<?php echo $row ['order_id']; ?> "><button>View Order</button></a></td>-->
                           </tr>
